...
# Connect to MySQL
connection = mysql.connector.connect(user='your_username', password='your_pass',host='localhost',port= 'yourport', database='yourDB')
cursor_msql=connection.cursor()
# Connect to DB2 or PostgreSql
dsn_hostname = 'localhost'
dsn_user='user'        # e.g. "abc12345"
dsn_pwd ='your pass'      # e.g. "7dBZ3wWt9XN6$o0J"
dsn_port ="your_port"                # e.g. "50000" 
dsn_database ="yourDB"
